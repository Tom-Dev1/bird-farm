          ...
          <Grid container spacing={2}>
            <Grid item xs={8}>
              ...
              <Stack spacing={2} direction={'row'}>
                <Card sx={{ minWidth: 49 + '%', height: 150 }} style={{ "background": "linear-gradient(158deg, rgba(40, 34, 70, 1) 0%, rgba(30, 47, 141, 1) 100%)" }}>
                  <CardContent>
                    <div>
                ...
                <Card sx={{ minWidth: 49 + '%', height: 150 }} style={{ "background": "linear-gradient(158deg, rgba(53, 138, 148, 1) 0%, rgba(91, 180, 96, 1) 100%)" }}>
                  <CardContent>
                    <div>
            ...
            <Grid item xs={4}>
              <Stack spacing={2} >
                <Card style={{ "background": "linear-gradient(158deg, rgba(53, 138, 148, 1) 0%, rgba(91, 180, 96, 1) 100%)" }}>
                  <Stack spacing={2} direction='row'>
