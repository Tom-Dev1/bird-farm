            ...
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <TextField
                        ...
                        helperText={!validateUsername(editedUser.userName) && 'User Name phải có ít nhất 6 ký tự, ít nhất 1 số và ít nhất 1 ký tự đặc biệt.'}
                        sx={{ minWidth: "100%" }}
                        size='small'
                    />
                </Grid>
                ...
                <Grid item xs={12}>
                    <TextField
                        ...
                        onChange={handleInputChange}
                        helperText={!validatePassword(editedUser.userPassword) && 'Password phải có ít nhất 8 ký tự , 1 ký tự viết hoa và 1 ký tự đặc biệt'}
                        sx={{ minWidth: '100%' }}
                        size="small"
                        InputProps={{
                            endAdornment: (
